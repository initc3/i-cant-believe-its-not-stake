...
_compactblocks = __import__('p2p-compactblocks')
...
class NothingAtStakeDoSTest(BitcoinTestFramework):
    ...
    def nothing_at_stake_headers(self):
        ...
        print("Initial mapBlockIndex-size:", self.node.getinfo()['mapBlockIndex-size'], "\n")
        ...
        print('Please note the value of mapBLockIndex-size in getinfo()', 
            "We have altered the getInfo() rpc to also print the mapBLockIndex-size for this demo\n\n")
        print("Final mapBlockIndex-size:", self.node.getinfo()['mapBlockIndex-size'])
    ...
    def nothing_at_stake_disk(self):
        ...
        print_dir_size(self.node.datadir+'/regtest/blocks/')
        print('\n'*2)
