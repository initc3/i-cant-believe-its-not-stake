...
class CBlock(CBlockHeader):
    ...
    def serialize(self, with_witness=False):
        ...
        if with_witness:
            ...
            r += ser_string(self.vchBlockSig)
           #  r += bytes.fromhex("403044022075d1a31d4359923349fce3069fdb02e025536ad8fe8d14f4957ba880f379e4f00220799dbb823ba60e5bf3c2adff35f7eea3405024769ba073c9c1ca651cb825dfe3")
        return r
    ...
    def get_merkle_root(cls, hashes):
        while len(hashes) > 1:
            ...
            hashes = newhashes
        #print(uint256_from_str(hashes[0]))
    ...
    def calc_merkle_root(self):
        ...
        for tx in self.vtx:
           ...
           # print(tx.hash[::-1])
            #print(hex(tx.sha256))
            # print(tx.hash.hex())
            hashes.append(bytes.fromhex(tx.hash)[::-1])
        #print(hashes)
