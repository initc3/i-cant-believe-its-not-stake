...
class TestNode():
    ...
    def __init__(self, i, dirname, extra_args, rpchost, timewait, binary, stderr, mocktime, coverage_dir):
        ...
        if timewait:
            ...
            self.rpc_timeout = 60
        if binary is None:
            self.binary = os.getenv("BITCOIND", "stratisd")
        else:
            self.binary = binary
        self.stderr = stderr
    ...
    def start(self, extra_args=None, stderr=None):
        ...
        # self.args.append('-daemon')
        # self.args.append('rpcport='+str(rpc_port(self.index)))
        # self.args.append('rpcpassword=testing')
        #print(str(self.args) + "Testing")
